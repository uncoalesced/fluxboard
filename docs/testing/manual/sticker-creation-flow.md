...
## Prerequisites
1. Open the FluxBoard app on a device or emulator running Android 8.0 (API 26) or higher.
...
2. **Select Image**
   ...
   - *Expected:* The photo picker closes, and the FluxBoard crop/segmentation UI appears, showing the selected image.
