...
| | |
|---|---|
| SHA-256 | `D6EF89E9823545884D7FDF119896B0A05770E736A8D4022F87E88CF0C9F799A7` |
...
```
sha256sum FluxBoard-v0.1.4-ALPHA-release.apk
apksigner verify --print-certs FluxBoard-v0.1.4-ALPHA-release.apk
```

The certificate fingerprint is the one that matters. A matching file hash only
says the download was not corrupted; a matching certificate says the APK came
from this signing key and can therefore update an existing install in place.
